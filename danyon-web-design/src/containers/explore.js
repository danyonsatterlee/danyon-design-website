        ...
        return(
            ...
            <div  className="row">
                <div className="col-md-3 col-md-offset-1 col-sm-12 col-sm-offset-0 no-marg">
                     ...
                     <Link to = "/allexplore/"><div className="explore8 wow portfolio fadeIn" data-wow-offset="70" data-wow-delay="2.25s" data-wow-iteration="1"></div></Link>
                 ...
                 <div className="col-md-4 col-sm-12 col-sm-offset-0 no-marg">
                     ...
                     <Link to = "/allexplore"><div className="explore3 portfolio wow fadeIn" data-wow-offset="70" data-wow-delay="1.75s" data-wow-iteration="1"></div></Link>
                      <Link to = "/allexplore"><div className="explore9 wow portfolio fadeIn" data-wow-offset="70" data-wow-delay="1.25s" data-wow-iteration="1"></div></Link>
                     ...
                     <Link to = "/allexplore"><div className="explore6 portfolio wow fadeIn" data-wow-offset="70" data-wow-delay="1.25s" data-wow-iteration="1"></div></Link>
                      <Link to = "/allexplore"><div className="explore10 portfolio wow fadeIn" data-wow-offset="70" data-wow-delay="2s" data-wow-iteration="1"></div></Link>
